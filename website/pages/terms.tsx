        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="pt-32 pb-12 md:pt-40 md:pb-20">
            <div className="max-w-3xl mx-auto text-center">
              {/* 404 content */}
              <h1 className="h1 mb-4">Legal terms</h1>
              <div className="mt-8 text-justify">
                <h2 className="h2 mb-4">AGREEMENT TO TERMS</h2>

                <p className="mb-4">These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and François Voron ("<strong>Company</strong>," “<strong>we</strong>," “<strong>us</strong>," or “<strong>our</strong>”), concerning your access to and use of the <a href="https://www.francoisvoron.com">https://www.francoisvoron.com</a> website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). We are registered in France and have our registered office at 10 B rue Casimir Périer, Lyon 69002. Our VAT number is FR24521014746. You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
                ...
                <p className="mb-4">The Site is intended for users who are at least 18 years old. Persons under the age of 18 are not permitted to use or register for the Site.&nbsp;</p>

                <h2 className="h2 mb-4">INTELLECTUAL PROPERTY RIGHTS</h2>
                ...
                <h2 className="h2 mb-4">USER REPRESENTATIONS</h2>
                ...
                <p className="mb-4">If you provide any information that is untrue, inaccurate, not current, or incomplete, we have the right to suspend or terminate your account and refuse any and all current or future use of the Site (or any portion thereof).</p>

                <h2 className="h2 mb-4">PROHIBITED ACTIVITIES</h2>
                ...
                <h2 className="h2 mb-4">USER GENERATED CONTRIBUTIONS</h2>
                ...
                <p className="mb-4">Any use of the Site in violation of the foregoing violates these Terms of Use and may result in, among other things, termination or suspension of your rights to use the Site.</p>

                <h2 className="h2 mb-4">CONTRIBUTION LICENSE</h2>

                <p className="mb-4">You and the Site agree that we may access, store, process, and use any information and personal data that you provide following the terms of the Privacy Policy and your choices (including settings).</p>
                <p className="mb-4">By submitting suggestions or other feedback regarding the Site, you agree that we can use and share such feedback for any purpose without compensation to you.&nbsp;</p>
                <p className="mb-4">We do not assert any ownership over your Contributions. You retain full ownership of all of your Contributions and any intellectual property rights or other proprietary rights associated with your Contributions. We are not liable for any statements or representations in your Contributions provided by you in any area on the Site. You are solely responsible for your Contributions to the Site and you expressly agree to exonerate us from any and all responsibility and to refrain from any legal action against us regarding your Contributions.</p>

                <h2 className="h2 mb-4">SUBMISSIONS</h2>
                ...
                <h2 className="h2 mb-4">THIRD-PARTY WEBSITE AND CONTENT</h2>
                ...
                <h2 className="h2 mb-4">SITE MANAGEMENT</h2>
                ...
                <h2 className="h2 mb-4">TERM AND TERMINATION</h2>
                ...
                <h2 className="h2 mb-4">MODIFICATIONS AND INTERRUPTIONS</h2>
                ...
                <h2 className="h2 mb-4">GOVERNING LAW</h2>

                <p className="mb-4">These conditions are governed by and interpreted following the laws of France, and the use of the United Nations Convention of Contracts for the International Sale of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law of your country of residence. François Voron and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Lyon, which means that you may make a claim to defend your consumer protection rights in regards to these Conditions of Use in France, or in the EU country in which you reside.</p>

                <h2 className="h2 mb-4">DISPUTE RESOLUTION</h2>

                <p className="mb-4">The European Commission provides an online dispute resolution platform, which you can access here:&nbsp;<a href="https://ec.europa.eu/consumers/odr">https://ec.europa.eu/consumers/odr</a>. If you would like to bring this subject to our attention, please contact us.</p>

                <h2 className="h2 mb-4">CORRECTIONS</h2>

                <p className="mb-4">There may be information on the Site that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Site at any time, without prior notice.</p>

                <h2 className="h2 mb-4">DISCLAIMER</h2>
                ...
                <h2 className="h2 mb-4">LIMITATIONS OF LIABILITY</h2>
                ...
                <h2 className="h2 mb-4">INDEMNIFICATION</h2>
                ...
                <h2 className="h2 mb-4">USER DATA</h2>

                <p className="mb-4">We will maintain certain data that you transmit to the Site for the purpose of managing the performance of the Site, as well as data relating to your use of the Site. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Site. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>

                <h2 className="h2 mb-4">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
                ...
                <h2 className="h2 mb-4">MISCELLANEOUS</h2>
                ...
                <p className="mb-4"><strong>François Voron</strong></p>
                <p className="mb-4"><strong>contact@francoisvoron.com</strong></p>
              </div>
            </div>
          </div>
        </div>
